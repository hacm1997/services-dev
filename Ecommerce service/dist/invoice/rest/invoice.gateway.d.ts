...
export declare abstract class InvoiceGateway {
    ...
    abstract getAllInvoiceById(code: string, tenantID: string): Promise<InvoiceModel[]>;
    abstract deleteInvoice(tenantID: string, id: string): Promise<any>;
    abstract putInvoiceStatus(invoiceID: string, status: string, tenantID: string): Promise<any>;
    abstract putInvoiceReference(invoiceID: string, reference: string, payment_method: string, tenantID: string): Promise<any>;
}
