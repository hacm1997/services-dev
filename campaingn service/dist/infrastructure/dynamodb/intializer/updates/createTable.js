...
const update_abstract_1 = require("../update.abstract");
const client_dynamodb_1 = require("@aws-sdk/client-dynamodb");
const Constants_1 = require("../Constants");
class CreateTable extends update_abstract_1.UpdateAbstract {
    constructor(id, clientDynamodb) {
        super(id, clientDynamodb);
        this.tableCampaignsCreation = {
            ...
            GlobalSecondaryIndexes: [
                ...
                {
                    IndexName: Constants_1.TENANT_INDEX,
                    KeySchema: [
        ...
        this.tableComprasCampaignsCreation = {
        ...
        this.tableTrackingEmailCreation = {
        ...
        this.tableContact = {
            ...
            GlobalSecondaryIndexes: [
                ...
                {
                    IndexName: Constants_1.COMPANY_INDEX,
                    KeySchema: [{ AttributeName: 'companyId', KeyType: 'HASH' }],
                    Projection: { ProjectionType: 'ALL' },
                    ProvisionedThroughput: { ReadCapacityUnits: 1, WriteCapacityUnits: 1 },
                },
                {
                    IndexName: Constants_1.PERSON_INDEX,
    ...
    async execute() {
        try {
            ...
            console.log(...oo_oo(`3335880623_230_6_230_56_4`, 'EXECUTION RESPONSE VALUE ', response));
        }
        catch (e) {
            console.log(...oo_oo(`3335880623_232_6_232_40_4`, `FULL ERROR #1: ${e}`));
            console.log(...oo_oo(`3335880623_233_6_233_53_4`, `FULL ERROR: ${JSON.stringify(e)}`));
    ...
    async executeCompras() {
        try {
            ...
            console.log(...oo_oo(`3335880623_243_6_243_56_4`, 'EXECUTION RESPONSE VALUE ', response));
        }
        catch (e) {
            console.log(...oo_oo(`3335880623_245_6_245_40_4`, `FULL ERROR #2: ${e}`));
            console.log(...oo_oo(`3335880623_246_6_246_53_4`, `FULL ERROR: ${JSON.stringify(e)}`));
            if (e.name === 'ResourceNotFoundException') {
    ...
    async executeBlog() {
        try {
            ...
            console.log(...oo_oo(`3335880623_256_6_256_56_4`, 'EXECUTION RESPONSE VALUE ', response));
        }
        catch (e) {
            console.log(...oo_oo(`3335880623_258_6_258_40_4`, `FULL ERROR #3: ${e}`));
            console.log(...oo_oo(`3335880623_259_6_259_58_4`, `FULL ERROR BLOG: ${JSON.stringify(e)}`));
            if (e.name === 'ResourceNotFoundException') {
    ...
    async executeHusport() {
        try {
            ...
            console.log(...oo_oo(`3335880623_269_6_269_56_4`, 'EXECUTION RESPONSE VALUE ', response));
        }
        catch (e) {
            console.log(...oo_oo(`3335880623_271_6_271_40_4`, `FULL ERROR #3: ${e}`));
            console.log(...oo_oo(`3335880623_272_6_272_61_4`, `FULL ERROR Husport: ${JSON.stringify(e)}`));
            if (e.name === 'ResourceNotFoundException') {
    ...
    async executeTrackingEmail() {
        try {
            ...
            console.log(...oo_oo(`3335880623_282_6_282_56_4`, 'EXECUTION RESPONSE VALUE ', response));
        }
        catch (e) {
            console.log(...oo_oo(`3335880623_284_6_284_40_4`, `FULL ERROR #3: ${e}`));
            console.log(...oo_oo(`3335880623_285_6_285_67_4`, `FULL ERROR TrackingEmail: ${JSON.stringify(e)}`));
            if (e.name === 'ResourceNotFoundException') {
    ...
    async executeContact() {
        try {
            ...
            console.log(...oo_oo(`3335880623_295_6_295_56_4`, 'EXECUTION RESPONSE VALUE ', response));
        }
        catch (e) {
            console.log(...oo_oo(`3335880623_332_6_332_40_4`, `FULL ERROR #3: ${e}`));
            console.log(...oo_oo(`3335880623_333_6_333_67_4`, `FULL ERROR TrackingEmail: ${JSON.stringify(e)}`));
            if (e.name === 'ResourceNotFoundException') {
    ...
    async updateTableWithIndex(tableName, newIndexName, newIndexSchema) {
        try {
            const updateParams = {
                TableName: tableName,
            ...
            console.log(...oo_oo(`3335880623_364_6_364_79_4`, 'Tabla actualizada con éxito con el nuevo índice:', response));
        }
        catch (error) {
    ...
    async removeIndexFromTable(tableName, indexNameToRemove) {
        try {
            const updateParams = {
                TableName: tableName,
                GlobalSecondaryIndexUpdates: [
            ...
            const command = new client_dynamodb_1.UpdateTableCommand(updateParams);
            const response = await this.clientDynamodb.docClient.send(command);
            console.log(...oo_oo(`3335880623_386_6_389_7_4`, `Índice "${indexNameToRemove}" eliminado con éxito de la tabla "${tableName}":`, response));
        }
        catch (error) {
