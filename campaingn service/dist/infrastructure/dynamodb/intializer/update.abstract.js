...
exports.UpdateAbstract = void 0;
const common_1 = require("@nestjs/common");
const Constants_1 = require("./Constants");
const ResourceAlreadyExistException_1 = require("../ResourceAlreadyExistException");
const client_dynamodb_1 = require("../client.dynamodb");
let UpdateAbstract = class UpdateAbstract {
    constructor(id, fullClientDynamodb) {
        this.id = id;
        this.fullClientDynamodb = fullClientDynamodb;
    }
    async checkCurrentChange() {
        console.log(...oo_oo(`786536087_24_4_24_54_4`, `Checking Changes for ID: ${this.id}`));
        const result = await this.getLog();
        console.log(...oo_oo(`786536087_26_4_26_59_4`, `RECEIVED ITEM: ${JSON.stringify(result)}`));
        if (result.Item)
            throw new ResourceAlreadyExistException_1.ResourceAlreadyExistException();
        return result;
    }
    async checkCurrentChangeCompras() {
        console.log(...oo_oo(`786536087_31_4_31_54_4`, `Checking Changes for ID: ${this.id}`));
        const result = await this.getLogCompras();
        console.log(...oo_oo(`786536087_33_4_33_59_4`, `RECEIVED ITEM: ${JSON.stringify(result)}`));
        if (result.Item)
            throw new ResourceAlreadyExistException_1.ResourceAlreadyExistException();
        return result;
    }
    async checkCurrentChangeBlog() {
        console.log(...oo_oo(`786536087_38_4_38_54_4`, `Checking Changes for ID: ${this.id}`));
        const result = await this.getLogBlog();
        console.log(...oo_oo(`786536087_40_4_40_59_4`, `RECEIVED ITEM: ${JSON.stringify(result)}`));
        if (result.Item)
            throw new ResourceAlreadyExistException_1.ResourceAlreadyExistException();
        return result;
    }
    async checkCurrentChangeHubsport() {
        console.log(...oo_oo(`786536087_45_4_45_54_4`, `Checking Changes for ID: ${this.id}`));
        const result = await this.getLogHubsport();
        console.log(...oo_oo(`786536087_47_4_47_59_4`, `RECEIVED ITEM: ${JSON.stringify(result)}`));
        if (result.Item)
            throw new ResourceAlreadyExistException_1.ResourceAlreadyExistException();
        return result;
    }
    async checkCurrentChangeTrackingEmail() {
        console.log(...oo_oo(`786536087_52_4_52_54_4`, `Checking Changes for ID: ${this.id}`));
        const result = await this.getLogTrackingEmail();
        console.log(...oo_oo(`786536087_54_4_54_59_4`, `RECEIVED ITEM: ${JSON.stringify(result)}`));
        if (result.Item)
            throw new ResourceAlreadyExistException_1.ResourceAlreadyExistException();
        return result;
    }
    async checkCurrentChangeConatc() {
        console.log(...oo_oo(`786536087_59_4_59_54_4`, `Checking Changes for ID: ${this.id}`));
        const result = await this.getLogConatct();
        console.log(...oo_oo(`786536087_61_4_61_59_4`, `RECEIVED ITEM: ${JSON.stringify(result)}`));
        if (result.Item)
            throw new ResourceAlreadyExistException_1.ResourceAlreadyExistException();
        return result;
    }
    async getLog() {
        ...
        console.log(...oo_oo(`786536087_74_4_74_50_4`, `Checking updates for ${this.id}`));
    ...
    async getLogCompras() {
        ...
        console.log(...oo_oo(`786536087_85_4_85_50_4`, `Checking updates for ${this.id}`));
        return await this.fullClientDynamodb.fullClient.getItem(query);
    }
    async getLogBlog() {
        const query = {
        ...
        console.log(...oo_oo(`786536087_96_4_96_50_4`, `Checking updates for ${this.id}`));
        return await this.fullClientDynamodb.fullClient.getItem(query);
    }
    async getLogHubsport() {
        const query = {
            Key: {
                pid: { S: this.id },
                sid: { S: this.id },
        ...
        console.log(...oo_oo(`786536087_107_4_107_50_4`, `Checking updates for ${this.id}`));
        return await this.fullClientDynamodb.fullClient.getItem(query);
    }
    async getLogTrackingEmail() {
        const query = {
            Key: {
                pid: { S: this.id },
                sid: { S: this.id },
        ...
        console.log(...oo_oo(`786536087_118_4_118_50_4`, `Checking updates for ${this.id}`));
        return await this.fullClientDynamodb.fullClient.getItem(query);
    }
    async getLogConatct() {
        const query = {
        ...
        console.log(...oo_oo(`786536087_129_4_129_50_4`, `Checking updates for ${this.id}`));
        return await this.fullClientDynamodb.fullClient.getItem(query);
    }
    async setUpdateLogTable() {
        console.log(...oo_oo(`786536087_134_4_136_5_4`, `Finalizing Update for ${this.id}\nThe process will last 40 seconds`));
    ...
    async executeUpdateLogTableCompras() {
        const item = {
            TableName: Constants_1.TABLE_COMPRA_NAME,
            Item: {
                pid: { S: this.id },
    ...
    async executeUpdateLogTableBlog() {
        const item = {
            TableName: Constants_1.TABLE_BLOG_NAME,
            Item: {
                pid: { S: this.id },
    ...
    async executeUpdateLogTableHubsport() {
        const item = {
            TableName: Constants_1.TABLE_HUBSPORT_NAME,
            Item: {
                pid: { S: this.id },
    ...
    async executeUpdateLogTableTrackingEmail() {
        const item = {
            TableName: Constants_1.TABLE_TRACKING_NAME,
            Item: {
                pid: { S: this.id },
    ...
    async executeUpdateLogTableContact() {
        const item = {
            TableName: Constants_1.TABLE_CONTACT_NAME,
            Item: {
                pid: { S: this.id },
...
exports.UpdateAbstract = UpdateAbstract = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [String, client_dynamodb_1.ClientDynamodb])
], UpdateAbstract);
;
function oo_cm() { try {
...
;
oo_te;
//# sourceMappingURL=update.abstract.js.map